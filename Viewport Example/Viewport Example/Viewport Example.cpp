// Viewport Example.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
#include <glut.h>
#include <gl/gl.h>
#include <gl/glu.h>
...
void MyDisplay() {
	...
	glColor3f(1.0, 1.0, 1.0); // 기본값이기 때문에 똑같은 결과가 나온다.
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("Viewport Example"); // 이거 있어야 기본 실행됨

	glClearColor(0.0, 0.0, 0.0, 1.0); // 검정색으로! 마지막 파라미터는 불투명도를 나타냄 1이기 때문에 불투명한 것으로 나온다.
